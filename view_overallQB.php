<html>
<head>
  <title>Overall Questions-Feedback Online</title>
...
<body>
   <br><br><br>
	<center>
   <font size="5" style='cursor:default;' >Questions For Overall Feedback</font><br><br>
      <div CLASS="dlong" align="left" >
        ...
        // Create connection
          ...
          $query = "SELECT question,id,status FROM question_bank where overall='y';";
      ...
      <p><button style=" width:250px; height:30px;"><a href='ofeedback_alterQ.php' style='display:block; color:#006699; cursor:pointer;'>Alter Questions</a></button> <b><?php echo $m = isset($_GET['altermsg']) ?  $_GET['altermsg']  : "";  ?><b></p>
	 </center>
</html>
