<html>
<head>
  <title>Alter Overall Questions-Feedback Online</title>
  ...
  <center>
	 ...
	 <font color='#f1f1f1'  size='5' style='cursor:default;' >Online Feedback Application </font>
	  ...
	  <a href='view_overallQB.php' style="position:relative; top:-15px; left:2px; color:#f1f1f1;"><font size="4"><b>Back</b></font></a>
...
<body >
	  <br><br><br>
	  <center>
   <font size="5" style='cursor:default;'>Alter Questions For Overall Feedback</font><br><br>
      <div CLASS="dlong" align="left" >
        ...
        // Create connection
          ...
          $query = "SELECT question,id,overall,status FROM question_bank;";
          $result = mysqli_query($link, $query);
          echo"<form method='post' action='ofeedback_alterDB.php'>";
          while(list($ques,$id,$overall,$status)=mysqli_fetch_row($result))
		  {   
