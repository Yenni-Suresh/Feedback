<html>
<head>
<title>Individual Lab-Feedback Online</title>
...
<body>
  ...
  <br>
  <center>
   <font size='5' color='#006699' style='cursor:default;'><b>Individual Feedback ( Lab )</b></font><br><br><br>
	 <form method='post' action='submit_indi_lab.php'>
	  <?php
        
		  	$query="select year,sec,sub_lab from indi_details;";
		   $res = mysqli_query($link, $query);
		   while(list($yr,$sec,$f)=mysqli_fetch_row($res))
		   {
		   	 $year=$yr;
		   	 $section=$sec;
		   	 $sub=$f;
